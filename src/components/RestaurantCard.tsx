    ...
    >
      <div className="p-5 flex flex-col flex-grow">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-medium text-lg text-balance">{restaurant.name}</h3>
        ...
        <div className="mt-auto pt-3">
          <a 
            ...
            className="inline-flex items-center px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 transition-colors text-sm font-medium"
          >
